 ...
 */
public class FinanceAccountBillCheckRespDto implements Serializable {
    ...
    private Long            cpmAmount;                              //Long,通过CPM得到的收入(单位：分)
    private Long              cpcClickCount;                          //Long,CPC点击数目
    private Long            cpcAmount;                              //Long,通过CPC得到的收入(单位：分)
    private Long            occupyAmount;                           //Long,通过独占得到的收入(单位：分)
    private Long            amount;                                 //Long,总价(单位：分)
    ...
    public Long getCpmAmount() {
        return cpmAmount;
    }
    public void setCpmAmount(Long cpmAmount) {
    ...
    public Long getCpcAmount() {
        return cpcAmount;
    }
    public void setCpcAmount(Long cpcAmount) {
