...
/**
 * 类FinanceReceiveResponse.java的实现描述：TODO 类实现描述
 * 
 * @author yanji 2016年6月12日 下午1:41:13
 */
public class FinanceReceiveResponse {
    private int                              status  = HttpStatus.OK.value();

    private String                           message = HttpStatus.OK.name();

    private List<FinanceAccountBillCheckRespDto> data;
    ...
    public List<FinanceAccountBillCheckRespDto> getData() {
        return data;
    }

    public void setData(List<FinanceAccountBillCheckRespDto> data) {
        this.data = data;
    }
