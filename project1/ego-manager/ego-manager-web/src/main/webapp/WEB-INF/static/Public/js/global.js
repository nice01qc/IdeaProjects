 ...
 * 获取多级联动的商品分类
 */
function get_category(parentId,next,select_id,hidden_id){
	$("#"+hidden_id).val(parentId);
    $.ajax({
        type : "POST",
        url  : $("#contextPath").val()+"/product/category/getByPid",
...
//选中分类时，给隐藏域赋值
function set_category_hidden(id,hidden_id){
	$("#"+hidden_id).val(id);
}
