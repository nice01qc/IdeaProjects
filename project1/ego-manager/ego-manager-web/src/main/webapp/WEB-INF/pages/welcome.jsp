...
<div class="wrapper">
	...
	<li><a href="javascript:void();"><i class="fa fa-home"></i>&nbsp;&nbsp;后台首页</a></li>
	        ...
	        <li><a href="javascript:void();">ego系统管理</a></li>    
				        	...
				        	<div class="info-box">
					         	<table class="table table-bordered">
					         		<tr>
					         			...
					         			<td>程序开发：</td><td>北京506网络有限公司</td>			         			
					         		</tr>
					         		<tr>
					         			<td>版权所有：</td><td>北京506网络有限公司</td>
					         			<td>官方授权：</td><td><a href="http://www.ego.cn/" target="_blank">商业授权</a></td>
					         			<td>官方论坛：</td><td><a href="http://www.ego.cn/articleList_cat_id_31.html" target="_blank">ego交流论坛</a></td>
					         		</tr>
					         	</table>
				         	</div>
				        </div>
