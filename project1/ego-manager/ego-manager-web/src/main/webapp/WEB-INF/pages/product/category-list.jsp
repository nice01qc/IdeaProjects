...
<html>
  ...
  <body style="background-color:#ecf0f5;">
    <div class="wrapper">
      <div class="breadcrumbs" id="breadcrumbs">
        <ol class="breadcrumb">
          ...
          <li>
            <a href="javascript:void();">商品分类</a></li>
        </ol>
      </div>
                ...
                <nav class="navbar navbar-default">
                  <div class="collapse navbar-collapse">
                    <div class="navbar-form row">
                      <div class="col-md-1">
                        <button class="btn bg-navy" type="button" onclick="tree_open(this);">
                          <i class="fa fa-angle-double-down"></i>展开</button>
                      </div>
                      <div class="col-md-9">
                        <span class="warning">温馨提示：顶级分类（一级大类）设为推荐时才会在首页楼层中显示</span></div>
                      <div class="col-md-2">
                        <a href="${ctx }/product/category/add" class="btn btn-primary pull-right">
                          <i class="fa fa-plus"></i>新增分类</a>
                      </div>
                    </div>
                  </div>
                </nav>
                      ...
                      <tbody>
                        ...
                        <tr role="row" align="center" class="1" id="1_1">
                          ...
                          <td align="left" style="padding-left:5em">
                            ...
                            <span>${goodsCategory.name }</span></td>
                          <td>
                            <span>${goodsCategory.mobileName }</span></td>
                          <td>
                            ...
                            onclick="changeTableVal('goods_category','id','1','is_hot',this)" /></td>
                          <td>
                            <img width="20" height="20" 
                            ...
                            src="${ctx}/Public/images/cancel.png" 
                             ...
                             onclick="changeTableVal('goods_category','id','1','is_show',this)" /></td>
                          <td>
                            <input type="text" onchange="updateSort('goods_category','id','1','cat_group',this)" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" size="4" value="${goodsCategory.catGroup }" class="input-sm" /></td>
                          <td>
                            <input type="text" onchange="updateSort('goods_category','id','1','sort_order',this)" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" size="4" value="${goodsCategory.sortOrder }" class="input-sm" /></td>
                          <td>
                            <a class="btn btn-primary" href="${ctx }/goods/category/edit/${goodsCategory.id}">
                              <i class="fa fa-pencil"></i>
                            </a>
                            <a class="btn btn-danger" href="javascript:del_fun('${ctx }/goods/category/del/${goodsCategory.id}');">
                              <i class="fa fa-trash-o"></i>
                            </a>
                          </td>
                        </tr>
                        <c:forEach var="goodsCategory2" items="${goodsCategory.children }">
                        <tr role="row" align="center" class="2" id="2_12" style="display:none">
                          <td>${goodsCategory2.id }</td>
                          <td align="left" style="padding-left:10em">
                            ...
                            <span>${goodsCategory2.mobileName }</span></td>
                          <td>
                            <span>${goodsCategory2.name }</span></td>
                          <td>
                            <img width="20" height="20" 
                            <img width="20" height="20" 
                            ...
                            src="${ctx}/Public/images/cancel.png" 
                             ...
                             onclick="changeTableVal('goods_category','id','12','is_hot',this)" /></td>
                          <td>
                            <img width="20" height="20"
                            <img width="20" height="20" 
                            ...
                            src="${ctx}/Public/images/cancel.png" 
                             ...
                             onclick="changeTableVal('goods_category','id','12','is_show',this)" /></td>
                          <td>
                            <input type="text" onchange="updateSort('goods_category','id','12','cat_group',this)" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" size="4" value="${goodsCategory2.catGroup }" class="input-sm" /></td>
                          <td>
                            <input type="text" onchange="updateSort('goods_category','id','12','sort_order',this)" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" size="4" value="${goodsCategory2.sortOrder }" class="input-sm" /></td>
                          <td>
                            <a class="btn btn-primary" href="${ctx }/goods/category/edit/${goodsCategory2.id}">
                              <i class="fa fa-pencil"></i>
                            </a>
                            <a class="btn btn-danger" href="javascript:del_fun('${ctx }/goods/category/del/${goodsCategory2.id}');">
                              <i class="fa fa-trash-o"></i>
                            </a>
                          </td>
                        </tr>
                        <c:forEach var="goodsCategory3" items="${goodsCategory2.children }">
                        <tr role="row" align="center" class="3" id="3_100" style="display:none">
                          <td>${goodsCategory3.id }</td>
                          <td align="left" style="padding-left:15em">
                            <span>${goodsCategory3.mobileName }</span></td>
                          <td>
                            <span>${goodsCategory3.name }</span></td>
                          <td>
                            <img width="20" height="20" 
                            <img width="20" height="20" 
                          ...
                          <td>
                            <input type="text" onchange="updateSort('goods_category','id','12','sort_order',this)" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" size="4" value="${goodsCategory2.sortOrder }" class="input-sm" /></td>
                          <td>
                            <a class="btn btn-primary" href="${ctx }/goods/category/edit/${goodsCategory3.id}">
                              <i class="fa fa-pencil"></i>
                            </a>
                            <a class="btn btn-danger" href="javascript:del_fun('${ctx }/goods/category/del/${goodsCategory3.id}');">
                              <i class="fa fa-trash-o"></i>
                            </a>
                          </td>
                        </tr>
    ...
    <script type="text/javascript">// 展开收缩
