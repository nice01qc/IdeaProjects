...
<div id="doc">
	<div id="s_hdw">
		...
		<div class="mmenu">
			<div class="s_hd">
				<div id="s_search">
					<form action="${ctx }/search/index" method="get"><input name="searchStr" type="text" class="search-input" /><input name="" type="image" src="${ctx}/static/images/btn_search.jpg" /></form>
				</div>
		...
		<div id="s_bd">
									...
									<dd>
										<div class="cat_list_box slide_cont">
											<ul>
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg1-1.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg1-2.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg1-3.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg1-4.jpg" border="0" /></a></div>
									...
									<dd>
										<div class="cat_list_box slide_cont">
											<ul>
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg2-1.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg2-2.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg2-3.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg2-4.jpg" border="0" /></a></div>
									...
									<dd>
										<div class="cat_list_box slide_cont">
											<ul>
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg3-1.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg3-2.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg3-3.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg3-4.jpg" border="0" /></a></div>
									...
									<dd>
										<div class="cat_list_box slide_cont">
											<ul>
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg4-1.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg4-2.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg4-3.jpg" border="0" /></a></div>
												...
												<li>
													<div class="cat_pd">
														<div class="pic"><a href="#"><img src="${ctx}/static/images/qg4-4.jpg" border="0" /></a></div>
			...
			<div class="i_channels_cont">
				...
				<div class="channel_rgt">
					<div class="small_ad_box">
						<ul>
							<li><a href="#"><img src="${ctx}/static/images/cat_s_2-1.jpg" width="208" height="63" border="0" /></a></li>
							<li><a href="#"><img src="${ctx}/static/images/cat_s_2-2.jpg" width="208" height="63" border="0" /></a></li>
							<li><a href="#"><img src="${ctx}/static/images/cat_s_ad_2_3.jpg" width="203" height="98" border="0" /></a></li>
						</ul>
					</div>
				</div>
...
<!-- 商品分类模板 -->
<script type="template" id="goodsCategoryTempl">
{{ for(i=0;i<it.length;i++){ }}
<li class="cat_item">
		<h4 class="cat_tit"><a href="#" class="cat_tit_link">{{=it[i].name}}</a><span class="s_arrow">></span></h4>
		<div class="cat_cont">
			<div class="cat_cont_lft">
			{{ for(j=0;j<it[i].children.length;j++){ }}
			<dl class="cf">
				<dt><a href="#">{{=it[i].children[j].name}}</a></dt>
				<dd>
					<ul>
						{{ for(k=0;k<it[i].children[j].children.length;k++){ }}
						<li 
							{{ if(k==0){ }}	
							class="first"
							{{ } }}
							><a href="#">{{=it[i].children[j].children[k].name}}</a></li>
						{{ } }}
					</ul>
				</dd>
			</dl>
...
<script type="text/javascript">
	$(function(){
		$.ajax({
			url:"${ctx}/goodsCategory/getAll",
			data:"",
			type:"POST",
			dataType:"JSON",
			success:function(result){
				//调用模板
				var templ = doT.template($("#goodsCategoryTempl").text());
				//填充内容
