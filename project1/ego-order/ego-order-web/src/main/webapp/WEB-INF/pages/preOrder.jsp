...
<div id="doc">
	...
	<div id="s_bdw">
		<div id="s_bd">
					...
					<tr>
						...
						<td class="summary">
							<table class="catlist" width="100%">
								<tr bgcolor="#f3f3f3">
									<th>购物车中的商品</th><th>EGO价</th><th>返现</th><th>送积分</th><th>购买数量</th><th>发货时间</th>
								</tr>
								<tr>
			...
			<div class="catinfotable">
				<form action="${ctx }/order/confirmOrder" method="POST">
						...
						<td class="summary">
							...
							<div class="f-r" style="width:170px;padding:0 15px;background:#f3f3f3;">
								<table class="totable" width="100%">
									...
									<tr>
										<td>合&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计：</td><td align="right"><strong style="font-size:18px;color:#dc0000;">￥${goodsAllamount}</strong></td>
									</tr>
									<tr>
